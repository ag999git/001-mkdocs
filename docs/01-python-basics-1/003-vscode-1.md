...
* [1. VS Code Basics](003-vscode-1.md#1-vs-code-basics)
* [2. Setup](003-vscode-1.md#2-setup)
* [3. VS Code Interface](003-vscode-1.md#3-vs-code-interface)
* [4. Some important Extensions for Python programming](003-vscode-1.md#4-some-important-extensions-for-python-programming)
* [5. Python workflow in VS Code](003-vscode-1.md#5-python-workflow-in-vs-code)
* [6. How to Create a Python Project](003-vscode-1.md#6-how-to-create-a-python-project)
* [7. How to Run Python Scripts in VS Code](003-vscode-1.md#7-how-to-run-python-scripts-in-vs-code)
* [8. Common Beginner Errors and Quick Fixes](003-vscode-1.md#8-common-beginner-errors-and-quick-fixes)
* [9. Debug](003-vscode-1.md#9-debug)
* [10. Debugging common beginner mistakes](003-vscode-1.md#10-debugging-common-beginner-mistakes)
* [11. FAQ](003-vscode-1.md#10-faq)
* [12. FAQ VS Code User Interface](003-vscode-1.md#12-faq-vs-code-user-interface)
* [13 VS Code IntelliSense FAQ](003-vscode-1.md#13-vs-code-intellisense-faq)
* [14 VS Code Terminal FAQ](003-vscode-1.md#14-vs-code-terminal-faq)
* [Disclaimer](003-vscode-1.md#disclaimer)
...
[Back to Table of Contents](003-vscode-1.md#table-of-contents)
...
* “Would you like to install recommended extensions?” → Optional VS Code opens with a **welcome page** that includes:
  * A "Get Started" guide
  * Themes (light/dark)
...
* Your opened folder
*   Files inside it Ueful for Python beginners:\
    ✔ Create new files\
    ✔ Create folders\
...
**Fix:-** Bottom-left → click where it says: Python: . Pick correct interpreter:
...
VS Code (Visual Studio Code) is a free, lightweight code editor made by Microsoft. It is not a full heavyweight IDE like PyCharm, but it becomes powerful by adding extensions (plugins).

### 2. Is VS Code free to download?

✅ Yes, 100% free You can use it forever — no trial, no subscription.

### 3. Where should I download VS Code from?

Always download from the official Microsoft website: https://code.visualstudio.com/ Never download from third-party websites.

### 4. What version should I download for Windows?

Choose this:- User Installer (64-bit) This is the simplest and recommended for beginners.
...
Yes. VS Code does not include Python. Download Python from: https://www.python.org/downloads/ Make sure you check: ✔ Add Python to PATH (VERY important for Windows)

### 7. Do I need to add Python to PATH manually?

If you checked Add Python to PATH during installation → No If not → VS Code will not detect Python. To fix it: Reinstall Python → check Add to PATH

### 8. How do I check if Python is installed correctly?

Open Command Prompt and type: python --version If it shows a version like 3.12.x, you're good. If you see: ‘python’ is not recognized... → Python PATH is not set → reinstall Python with PATH enabled.

### 9. How do I install Python extension in VS Code?

Open VS Code → left sidebar Extensions icon → search: Python Click Install on: ✔ Microsoft Python extension (official) VS Code will now: • Detect Python • Enable debugging • Enable IntelliSense (autocomplete) • Show errors and warnings

### 10. Do I need any other extensions as a beginner?

Not required. But recommended: ✔ Python (by Microsoft) ✔ Pylance (improves autocomplete) ✔ Jupyter (for Notebook-style code)
...
6. Choose the Python version installed on your PC This solves most issues.

### 12. Should I use VS Code or PyCharm as a beginner?

Use VS Code because it is: • lighter • easier to navigate • fast to install • works well on normal laptops • easier for school/college beginners PyCharm is very powerful but heavier.

### 13. Will VS Code slow down my computer?

No. It is one of the most lightweight code editors.

### 14. Do I need internet to use VS Code?

Only for installing extensions the first time. After that, no internet needed for writing or running code.

### 15. Can I run Python scripts inside VS Code?

Yes. Just open your .py file and click: ▶ Run or press: Ctrl + F5

### 16. What if I open VS Code and see a blank screen?

You must open a folder, not individual files. Steps:
...
Yes, VS Code is from Microsoft and is widely used in: • engineering colleges • IITs • coaching institutes • professional companies
...
Try these fixes: ✔ Restart VS Code ✔ Restart Windows ✔ Select interpreter manually ✔ Reinstall Python with PATH
