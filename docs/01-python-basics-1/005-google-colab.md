...
You can access a working Google Colab Notebook by clicking the link below
...
* [Google Colab – Beginner-Friendly Guide](005-google-colab.md#google-colab-beginner-friendly-uide)
* [2. How to Access Google Colab](005-google-colab.md#2-how-to-access-google-colab)
* [3. How to Create a New Notebook](005-google-colab.md#3-how-to-create-a-new-notebook)
* [4. Basic Interface Overview](005-google-colab.md#4-basic-interface-overview)
* [5. How to Run Code](005-google-colab.md#5-how-to-run-code)
* [6. How to Install Libraries](005-google-colab.md#6-how-to-install-libraries)
* [7. Uploading and Downloading Files](005-google-colab.md#7-uploading-and-downloading-files)
* [8. Connecting to Google Drive](005-google-colab.md#8-connecting-to-google-drive)
* [9. Using GPU/TPU in Colab](005-google-colab.md#9-using-gputpu-in-colab)
* [FAQs on Google Colab](005-google-colab.md#faqs-on-google-colab)
  * [Difference between Google Colab and Jupyter Notebooks](005-google-colab.md#19-what-is-the-difference-between-colab-and-jupyter-notebook)
* [Summary](005-google-colab.md#summary)
* [Google Colab. Quick Cheatsheet](005-google-colab.md#google-colab-quick-cheatsheet)
  * [Magic commands](005-google-colab.md#9-magic-commands-very-useful)
  * [GPU/ TPU Usage](005-google-colab.md#10-gpu--tpu-usage)
  * [Markdown cheatsheet](005-google-colab.md#12-markdown-cheatsheet-for-text-cells)
* [Simple example scripts:- printing, variables, input, math, loops, lists, dictionaries, functions, string operations & error handling](005-google-colab.md#beginner-python-scripts-for-google-colab)
* [Beginner syllabus for learning Google colab](005-google-colab.md#beginner-syllabus-for-python--google-colab)

#### Google Colab – Beginner-Friendly Guide

Google Colab (short for _Colaboratory_) is a free, cloud-based Jupyter Notebook environment provided by Google.\
...
[Go back to Table of Contents](005-google-colab.md#table-of-contents)
...
_(Using built-in Matplotlib which is pre-installed in Colab)_
...
* TensorFlow or PyTorch GPU check\
  &#xNAN;_(No deep ML yet — just checking device)_
