...
![A Quick Map of Python Containers](../resources/ch18-qa-fig-01.png)
...
![Q11. Assigning a list versus copying a list](../resources/ch18-qa-fig-02.png)
...
![Q12. Aliasing and the bugs it causes](../resources/ch18-qa-fig-03.png)
...
```mermaid
flowchart TD
    S{"How is the matrix built"} -- "with the multiply" --> A["Step 1 - the inner part builds one row object of three zeros"]
    A --> B["Step 2 - the outer multiply by 4 stores that same row four times"]
    ...
    S -- "with a comprehension" --> F["Step 6 - the fix uses a list comprehension"]
...
![Q14. Why a repeated row is not four rows](../resources/ch18-qa-fig-04.png)
...
![Q21. The mutable default argument](../resources/ch18-qa-fig-05.png)
...
![Q29. Remove duplicates and keep the order](../resources/ch18-qa-fig-06.png)
...
```python
# Run the script just above this one first: it defines chop().
...
flowchart TD
    ...
    D --> M["Both paths go back to Step 2"]
    E --> M
    M --> B
...
![Q34. Merging two sorted lists](../resources/ch18-qa-fig-07.png)
...
```python
# Run the script just above this one first: it defines is_unique().
...
![Q47 and Q48. Transposing a matrix](../resources/ch18-qa-fig-08.png)
...
```python
# Run the script just above this one first: it defines matrix_transpose().
