...
The following table shows the status of reference count and the triggering of **del**() by the Python interpreter after p1 and p2 are created and deleted:-

| Action     | What happens to the Reference Count? | Does **del** run?        |
| ---------- | ------------------------------------ | ------------------------ |
